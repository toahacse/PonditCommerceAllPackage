                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header" style="padding: 5px; background-color: #7386D5;">
                            <h5 class="text-light" style="margin: 5px 15px 5px 15px;">User Information Trashed List</h5>
                        </div>
                        <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td style="display: flex">
                                                    <a class="btn btn-outline-warning btn-sm mr-1"
                                                        href="{{ route('user-informations.trashed.restore', $user_information->id) }}">
                                                        <i class="fas fa-store"></i>
                                                    </a>

                                                    <form action="{{ route('user-informations.trashed.destroy', $user_information->id ) }}"
                                                        method="POST">
                                                        {{ csrf_field() }}
                        ...
                        <div class="card-footer d-flex justify-content-center">
                            <a class="btn btn-outline-secondary btn-sm mr-1" href="{{ route('user-informations.index') }}"><i class="fas fa-list"></i></a>
                        </div>
                    </div>
                </div>
            </div>
