            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header" style="padding: 5px; background-color: #7386D5;">
                        <h5 class="text-light" style="margin: 5px 15px 5px 15px;">Create User Information</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('user-informations.store') }}" method="post" enctype="multipart/form-data">
                            <!-- {{ csrf_field() }} -->
                            ...
                            <div class="form-group row">
                                ...
                                <textarea
                                    ...
                                    value=""
                                    placeholder="Address"
                                    aria-describedby="detailHelp"></textarea>
                            </div>
                            <div class="form-group row">
