@extends('forntendtemplate::master')
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="sticky-sidebar">
                            ...
                            <div class="banner banner-fixed overlay-zoom overlay-dark">
                                <figure>
                                    <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/banner2.jpg" width="280" height="312"
                                    ...
                                    <div class="owl-carousel owl-nav-top" data-owl-options="{
                                        ...
                                        <div class="products-col">
                                            <div class="product product-list-sm">
                                                <figure class="product-media">
                                                    <a href="demo3-product.html">
                                                        <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/10.jpg"
                                            ...
                                            <div class="product product-list-sm">
                                                <figure class="product-media">
                                                    <a href="demo3-product.html">
                                                        <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/11.jpg"
                                                            alt="product" width="100" height="100"
                                                            style="background-color: #f5f5f5;" />
                                                    </a>
                                                </figure>
                                            ...
                                            <div class="product product-list-sm">
                                                <figure class="product-media">
                                                    <a href="demo3-product.html">
                                                        <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/12.jpg"
                                                            alt="product" width="100" height="100"
                                                            style="background-color: #f5f5f5;" />
                                                    </a>
                                                </figure>
                                ...
                                <div class="widget-body">
                                    <div class="owl-carousel owl-nav-top" data-owl-options="{
                                        ...
                                        <div class="post overlay-dark overlay-zoom">
                                            <figure class="post-media">
                                                <a href="post-single.html">
                                                    <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/blog/1.jpg" width="280"
                                                        height="195" alt="post"
                                        ...
                                        <div class="post overlay-dark overlay-zoom">
                                            <figure class="post-media">
                                                <a href="post-single.html">
                                                    <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/blog/2.jpg" width="280"
                                                        height="195" alt="post"
                                        ...
                                        <div class="post overlay-dark overlay-zoom">
                                            <figure class="post-media">
                                                <a href="post-single.html">
                                                    <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/blog/3.jpg" width="280"
                                                        height="195" alt="post"
                                        ...
                                        <div class="post overlay-dark overlay-zoom">
                                            <figure class="post-media">
                                                <a href="post-single.html">
                                                    <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/blog/4.jpg" width="280"
                                                        height="195" alt="post"
                                        ...
                                        <div class="testimonial">
                                            ...
                                            <div class="testimonial-info">
                                                <figure class="testimonial-author-thumbnail">
                                                    <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/agent.png" alt="user"
                                                        width="40" height="40" />
                                                </figure>
                    ...
                    <section class="intro-section mb-6">
                        <div class="owl-carousel owl-theme row owl-dot-inner owl-dot-white intro-slider animation-slider cols-1 mb-4"
                            ...
                            <div class="banner banner-fixed intro-slide1">
                                <figure>
                                    <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/slides/1.jpg" alt="intro-banner" width="880"
                                ...
                                <div class="banner-content">
                                    ...
                                    <figure class="intro1-image slide-animate" data-animation-options="{
                                        ...
                                        <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/slides/single.png" alt="Men" width="511"
                                            height="478">
                                    </figure>
                                </div>
                            ...
                            <div class="banner banner-fixed intro-slide2">
                                <figure>
                                    <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/slides/2.jpg" alt="intro-banner" width="880"
                            ...
                            <div class="banner banner-fixed intro-slide3">
                                <figure>
                                    <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/slides/3.jpg" alt="intro-banner" width="880"
                        ...
                        <div class="row">
                                ...
                                <div class="category category-absolute category-badge">
                                    <a href="#">
                                        <figure class="category-media">
                                            <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/banners/1.jpg" alt="category"
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="category category-absolute category-badge">
                                    <a href="#">
                                        <figure class="category-media">
                                            <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/banners/2.jpg" alt="category"
                        ...
                        <div class="row gutter-xs appear-animate" data-animation-options="{
                            ...
                            <div class="col-md-3 col-6 mb-4">
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="demo3-product.html">
                                            <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/1.jpg" alt="product"
                            ...
                            <div class="col-md-3 col-6 mb-4">
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="demo3-product.html">
                                            <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/2.jpg" alt="product"
                                                width="280" height="315" style="background-color: #f5f5f5;" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart" data-toggle="modal"
                            ...
                            <div class="col-md-3 col-6 mb-4">
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="demo3-product.html">
                                            <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/3.jpg" alt="product"
                                                width="280" height="315" style="background-color: #f5f5f5;" />
                                        </a>
                                        <div class="product-label-group">
                                            <label class="product-label label-new">new</label>
                            ...
                            <div class="col-md-3 col-6 mb-4">
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="demo3-product.html">
                                            <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/4.jpg" alt="product"
                                                width="280" height="315" style="background-color: #f5f5f5;" />
                                        </a>
                                        <div class="product-label-group">
                                            <label class="product-label label-new">new</label>
                            ...
                            <div class="col-md-3 col-6 mb-4">
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="demo3-product.html">
                                            <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/5.jpg" alt="product"
                                                width="280" height="315" style="background-color: #f5f5f5;" />
                                        </a>
                                        <div class="product-label-group">
                            ...
                            <div class="col-md-3 col-6 mb-4">
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="demo3-product.html">
                                            <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/6.jpg" alt="product"
                                                width="280" height="315" style="background-color: #f5f5f5;" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart" data-toggle="modal"
                            ...
                            <div class="col-md-3 col-6 mb-4">
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="demo3-product.html">
                                            <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/7.jpg" alt="product"
                                                width="280" height="315" style="background-color: #f5f5f5;" />
                                        </a>
                                        <div class="product-label-group">
                                            <label class="product-label label-new">new</label>
                            ...
                            <div class="col-md-3 col-6 mb-4">
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="demo3-product.html">
                                            <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/8.jpg" alt="product"
                                                width="280" height="315" style="background-color: #f5f5f5;" />
                                        </a>
                                        <div class="product-action-vertical">
                                            <a href="#" class="btn-product-icon btn-cart" data-toggle="modal"
                                ...
                                <div class="widget widget-products appear-animate" data-animation-options="{
                                    ...
                                    <div class="products-col">
                                        <div class="product product-list-sm">
                                            <figure class="product-media">
                                                <a href="demo3-product.html">
                                                    <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/9.jpg" alt="product"
                                        ...
                                        <div class="product product-list-sm">
                                            <figure class="product-media">
                                                <a href="demo3-product.html">
                                                    <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/10.jpg" alt="product"
                                                        width="100" height="100"
                                                        style="background-color: #f5f5f5;" />
                                                </a>
                                            </figure>
                                        ...
                                        <div class="product product-list-sm">
                                            <figure class="product-media">
                                                <a href="demo3-product.html">
                                                    <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/11.jpg" alt="product"
                                                        width="100" height="100"
                                                        style="background-color: #f5f5f5;" />
                                                </a>
                                            </figure>
                                ...
                                <div class="widget widget-products appear-animate" data-animation-options="{
                                    ...
                                    <div class="products-col">
                                        <div class="product product-list-sm">
                                            <figure class="product-media">
                                                <a href="demo3-product.html">
                                                    <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/12.jpg" alt="product"
                                                        width="100" height="100"
                                                        style="background-color: #f5f5f5;" />
                                                </a>
                                            </figure>
                                        ...
                                        <div class="product product-list-sm">
                                            <figure class="product-media">
                                                <a href="demo3-product.html">
                                                    <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/13.jpg" alt="product"
                                                        width="100" height="100"
                                                        style="background-color: #f5f5f5;" />
                                                </a>
                                            </figure>
                                        ...
                                        <div class="product product-list-sm">
                                            <figure class="product-media">
                                                <a href="demo3-product.html">
                                                    <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/14.jpg" alt="product"
                                                        width="100" height="100"
                                                        style="background-color: #f5f5f5;" />
                                                </a>
                                            </figure>
                                ...
                                <div class="widget widget-products appear-animate" data-animation-options="{
                                    ...
                                    <div class="products-col">
                                        <div class="product product-list-sm">
                                            <figure class="product-media">
                                                <a href="demo3-product.html">
                                                    <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/15.jpg" alt="product"
                                                        width="100" height="100"
                                                        style="background-color: #f5f5f5;" />
                                                </a>
                                            </figure>
                                        ...
                                        <div class="product product-list-sm">
                                            <figure class="product-media">
                                                <a href="demo3-product.html">
                                                    <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/16.jpg" alt="product"
                                                        width="100" height="100"
                                                        style="background-color: #f5f5f5;" />
                                                </a>
                                            </figure>
                                        ...
                                        <div class="product product-list-sm">
                                            <figure class="product-media">
                                                <a href="demo3-product.html">
                                                    <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/products/17.jpg" alt="product"
                                                        width="100" height="100"
                                                        style="background-color: #f5f5f5;" />
                                                </a>
                                            </figure>
                    ...
                    <section class="mb-10 pb-6">
                        ...
                        <div class="container">
                            <div class="owl-carousel owl-theme row brand-carousel cols-xl-6 cols-lg-5 cols-md-4 cols-sm-3 cols-2"
                                ...
                                <figure><img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/brands/1.png" alt="brand" width="180" height="100" />
                                </figure>
                                <figure><img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/brands/2.png" alt="brand" width="180" height="100" />
                                </figure>
                                <figure><img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/brands/3.png" alt="brand" width="180" height="100" />
                                </figure>
                                <figure><img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/brands/4.png" alt="brand" width="180" height="100" />
                                </figure>
                                <figure><img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/brands/5.png" alt="brand" width="180" height="100" />
                                </figure>
                            </div>
                        </div>
                    </section>
