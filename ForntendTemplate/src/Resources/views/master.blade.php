...
<head>
    ...
    @include('forntendtemplate::partials.style')
...
<body class="home">
    ...
    <div class="page-wrapper">
        ...
        @include('forntendtemplate::partials.header')
        ...
        <!-- End of Main -->
        @include('forntendtemplate::partials.footer')
        <!-- End Footer -->
    </div>
    <!-- Sticky Footer -->
    ...
    <div class="newsletter-popup newsletter-pop2 mfp-hide" id="newsletter-popup">
        <figure>
            <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/newsletter-popup2.jpg" width="500" height="264" alt="newsletter2" />
        </figure>
	...
	<!-- Plugins JS File -->
    @include('forntendtemplate::partials.scripts')
