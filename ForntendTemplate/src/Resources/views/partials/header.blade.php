                                        ...
                                        <div class="tab-pane active" id="signin">
                                            ...
                                            <div class="form-choice text-center">
                                                ...
                                                <div class="social-links">
                                                    <a href="#" title=" social-link" class="social-link
                                                        social-google fab fa-google border-no"></a>
                                                    <a href="#" title=" social-link" class="social-link
                                                        social-facebook fab fa-facebook-f border-no"></a>
                                                    <a href="#" title=" social-link" class="social-link
                                                        social-twitter fab fa-twitter border-no"></a>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="container">
            <div class="header-left">
                ...
                <a href="demo3.html" class="logo">
                    <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/demos/demo3/logo.png" alt="logo" width="153" height="44" />
                </a>
                <!-- End Logo -->
                        ...
                        <div class="products scrollable">
                            <div class="product product-wishlist">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/wishlist/product-1.jpg" width="100" height="100"
                                            alt="product" />
                                    </a>
                            ...
                            <div class="product product-wishlist">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/wishlist/product-2.jpg" width="100" height="100"
                                            alt="product" />
                                    </a>
                                    <button class="btn btn-link btn-close">
                                        <i class="fas fa-times"></i><span class="sr-only">Close</span>
                            ...
                            <div class="product product-wishlist">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/wishlist/product-3.jpg" width="100" height="100"
                                            alt="product" />
                                    </a>
                                    <button class="btn btn-link btn-close">
                                        <i class="fas fa-times"></i><span class="sr-only">Close</span>
                    ...
                    <div class="dropdown-box">
                        ...
                        <div class="products scrollable">
                            <div class="product product-cart">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/cart/product-1.jpg" alt="product" width="80"
                                            height="88" />
                                    </a>
                                    <button class="btn btn-link btn-close">
                                        <i class="fas fa-times"></i><span class="sr-only">Close</span>
                            ...
                            <div class="product product-cart">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/cart/product-2.jpg" alt="product" width="80"
                                            height="88" />
                                    </a>
                                    <button class="btn btn-link btn-close">
                                        <i class="fas fa-times"></i><span class="sr-only">Close</span>
                            ...
                            <div class="megamenu">
                                <div class="row">
                                    ...
                                    <div
                                        ...
                                        <figure>
                                            <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/menu/banner-1.jpg" alt="Menu banner" width="221"
                                                height="330" />
                                        </figure>
                            ...
                            <div class="megamenu">
                                <div class="row">
                                    ...
                                    <div
                                        ...
                                        <figure>
                                            <img src="{{ asset('/') }}vendor/forntendtemplate/assets/images/menu/banner-2.jpg" alt="Menu banner" width="221"
                                                height="330" />
                                        </figure>
