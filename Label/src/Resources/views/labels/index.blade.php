                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header" style="padding: 5px; background-color: #7386D5;">
                            <h5 class="text-light" style="margin: 5px 15px 5px 15px;">Label List</h5>
                        </div>
                        <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td style="display: flex">
                                                    <a class="btn btn-outline-primary btn-sm mr-1"
                                                        href="{{ route('labels.edit', $label->id) }}"><i
                                                            class="fas fa-edit"></i></a>

                                                    <form action="{{ route('labels.destroy', $label->id) }}"
                                                        method="POST">
                                                        @method('DELETE')
                                                        {{ csrf_field() }}
                        ...
                        <div class="card-footer d-flex justify-content-center">
                            <a class="btn btn-outline-secondary btn-sm mr-1" href="{{ route('labels.create') }}"><i
                                    class="fas fa-plus"></i></a>
                            <a class="btn btn-outline-info btn-sm mr-1" href="{{ route('labels.trashed') }}"><i class="fas fa-list"></i></a>
                        </div>
                    </div>
                </div>
            </div>
