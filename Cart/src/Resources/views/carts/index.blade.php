        ...
        <div class="row justify-content-center">
            <div class="col-10">
                ...
                <ul class="nav mt-3 mb-3 d-flex justify-content-between">
                    <li class="nav-item">
                        <h4><a class="nav-link active" href="{{ route('carts.create') }}">Add New</a></h4>
                    </li>
                    <li class="nav-item">
                        <h4><a class="nav-link active" href="{{ route('carts.trashed') }}">All Trashed Items</a></h4>
                    </li>
                </ul>
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td style="display: flex">
                            <a class="btn btn-outline-primary mr-1" href="{{ route('carts.edit', $cart->id) }}">Edit</a>
