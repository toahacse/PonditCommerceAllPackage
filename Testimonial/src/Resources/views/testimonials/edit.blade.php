            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header" style="padding: 5px; background-color: #7386D5;">
                        <h5 class="text-light" style="margin: 5px 15px 5px 15px;">Edit Testimonial</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('testimonials.update', $testimonial->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="inputDetail" class="col-2">Body</label>
                                <input
                                    type="text"
                                    class="form-control col-10"
                                    id="inputDetail"
                            ...
                            <div class="form-group row">
                                <label for="inputDetail" class="col-2">Designation</label>
                                <input
                                    type="text"
                                    class="form-control col-10"
                                    id="inputDetail"
                            ...
                            <div class="row">
                                <div class="col-2"></div>
                                <div class="col-10">
                                    <img src="{{ asset('/storage/testimonial-images/'.$testimonial->picture) }}" height="50px" width= "70px"  alt="" style="margin-bottom: 5px">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-2"></div>
                    ...
                    <div class="card-footer d-flex justify-content-center">
                        <a class="btn btn-outline-secondary btn-sm mr-1" href="{{ route('testimonials.index') }}"><i
