                ...
                <div class="col-12">
                    ...
                    <div class="card">
                                            ...
                                            <tr>
                                                ...
                                                <td style="display: flex">
                                                    <a class="btn btn-outline-warning btn-sm mr-1"
                                                        href="{{ route('testimonials.trashed.restore', $testimonial->id) }}">
                                                        <i class="fas fa-store"></i>
                                                    </a>

                                                    <form action="{{ route('testimonials.trashed.destroy', $testimonial->id ) }}"
                                                        method="POST">
                                                        {{ csrf_field() }}
                        ...
                        <div class="card-footer d-flex justify-content-center">
                            <a class="btn btn-outline-secondary btn-sm mr-1" href="{{ route('testimonials.index') }}"><i class="fas fa-list"></i></a>
                        </div>
                    </div>
                </div>
            </div>
