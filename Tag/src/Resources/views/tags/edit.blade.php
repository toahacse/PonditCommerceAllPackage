            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header" style="padding: 5px; background-color: #7386D5;">
                        <h5 class="text-light" style="margin: 5px 15px 5px 15px;">Edit Category</h5>
                    </div>
                    <div class="card-body">
                        ...
                        @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-2"></div>
                                <div class="col-10">
                                    <img src="{{ asset('/storage/category-images/'.$category->picture) }}" height="50px" width= "70px"  alt="" style="margin-bottom: 5px">
                                </div>
                            </div>
                    ...
                    <div class="card-footer d-flex justify-content-center">
                        <a class="btn btn-outline-secondary btn-sm mr-1" href="{{ route('categories.index') }}"><i
